...
Thank you for your interest in `loopback-soap`, an open source project
administered by IBM.

Contributing to `loopback-soap` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-soap)
